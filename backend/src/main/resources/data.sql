...
INSERT INTO course (id, name, code, ects, department_id, semester, year) VALUES (1, 'Intro to Programming', 'CS101', 6, 1, 1, 2024) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, code = EXCLUDED.code, ects = EXCLUDED.ects, department_id = EXCLUDED.department_id;
INSERT INTO course (id, name, code, ects, department_id, semester, year) VALUES (2, 'Data Structures', 'CS201', 6, 1, 3, 2024) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, code = EXCLUDED.code, ects = EXCLUDED.ects, department_id = EXCLUDED.department_id;
INSERT INTO course (id, name, code, ects, department_id, semester, year) VALUES (3, 'Algorithms', 'CS301', 6, 1, 5, 2024) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, code = EXCLUDED.code, ects = EXCLUDED.ects, department_id = EXCLUDED.department_id;
INSERT INTO course (id, name, code, ects, department_id, semester, year) VALUES (4, 'Circuit Theory', 'EE101', 5, 2, 1, 2024) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, code = EXCLUDED.code, ects = EXCLUDED.ects, department_id = EXCLUDED.department_id;
INSERT INTO course (id, name, code, ects, department_id, semester, year) VALUES (5, 'Anatomy I', 'MED101', 8, 4, 1, 2024) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, code = EXCLUDED.code, ects = EXCLUDED.ects, department_id = EXCLUDED.department_id;
INSERT INTO course (id, name, code, ects, department_id, semester, year) VALUES (6, 'Principles of Management', 'BUS101', 5, 5, 1, 2024) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, code = EXCLUDED.code, ects = EXCLUDED.ects, department_id = EXCLUDED.department_id;
